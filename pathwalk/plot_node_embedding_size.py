...
'''
def set_ax(ax,plt,xlabel="epochs",ylabel="Loss",fontsize=18):
...
if __name__ == "__main__":
    ...
    plt.yticks([94.2,95.0,95.5,96.0,96.5,96.6],size=14)
 
    set_ax(ax,plt, xlabel="embedding size", ylabel="Acc. on DanMu test set",fontsize=22)
    # style
    ...
    output_file = "../MySubmission/WSDM2023/pathwalk_ablation_embedding_size.jpg"
