...
if __name__ == "__main__":
    ...
    Acc = [96.53,96.44,96.52,96.59,96.42,96.50,96.54,96.44,96.68,96.52,96.42,96.42,96.43,96.57,96.43]
    plt.plot(X,Acc,'-',linewidth = 1.5, color = 'darkred', marker='.', markersize=10, label="")
    plt.xticks(X)

    set_ax(ax,plt, xlabel="K", ylabel="Acc. on DanMu test set")
    # style
    ...
    output_file = "./imgs/pathwalk_ablation_effect_K.jpg"
